...
- (void)setupContainerView
{
    ...
    self.containerView.backgroundColor = [UIColor colorWithRed:(25/255.0) green:(181/255.0) blue:(197/255.0) alpha:1];
    self.containerView.layer.cornerRadius = self.cornerRadius;
    self.containerView.layer.shadowOffset = CGSizeZero;
    self.containerView.layer.shadowRadius = self.shadowRadius;
    self.containerView.layer.shadowOpacity = 0.5;
    //self.containerView.layer.borderWidth = 1.0;
    //self.containerView.layer.borderColor = [[UIColor colorWithRed:(39/255.0) green:(205/255.0) blue:(222/255.0) alpha:1] CGColor];
...
- (UIButton *)buttonForItemIndex:(NSUInteger)index
{
	...
	switch (item.type) {
		...
		default:
			...
			[button setTitleColor:[UIColor colorWithRed:(39/255.0) green:(205/255.0) blue:(222/255.0) alpha:0.5] forState:UIControlStateNormal];
